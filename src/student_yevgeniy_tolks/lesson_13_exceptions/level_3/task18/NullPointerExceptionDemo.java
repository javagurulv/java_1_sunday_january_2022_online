...
class NullPointerExceptionDemo {
    ...
    Object object=null; //reference obj equals to null, but is not pointing to any object in heap
    object.hashCode();  //by calling built-in hashcode method, where is no code to in the location
